...
## 🔍 Features
- **User-Friendly Interface:** Navigate through your documents without confusion.
- **Multi-File Support:** Open and manage various document types such as PDFs, Word files, and text files.
- **Search Functionality:** Quickly find what you need using the search bar.
- **Cloud Integration:** Save and retrieve your documents from popular cloud storage services.
...
## 🔧 How to Use DimanDocs
Once you have installed DimanDocs, you can start using it immediately. Here are some basics:

1. **Opening Documents:** Click the "Open" button to browse for files. Select the document you want to view.
2. **Creating New Files:** Use the "New Document" button to create and save new files.
...
For any further questions or suggestions, don't hesitate to reach out. Happy document management!